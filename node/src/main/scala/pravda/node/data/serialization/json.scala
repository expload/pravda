...
trait TethysInstances extends pravda.common.serialization.TethysInstances {
  //----------------------------------------------------------------------
...
object json extends pravda.common.serialization.CommonTethysInstances with TethysInstances
