...
class PushWordSpec extends FlatSpec with Matchers {
  ...
  "One-byte word" should "be converted to 1 Byte" in {
    ...
    Vm.runTransaction(ByteBuffer.wrap(program), emptyState).stack.toArray shouldBe Array(bytes(0x15))
  }
